...
_C.MODEL.PRETRAIN_CKPT = './pretrained_ckpt/ckpt_epoch_29.pth'
_C.MODEL.RESUME = ''
# Number of classes, overwritten in data preparation
_C.MODEL.NUM_CLASSES = 74
# Dropout rate
...
_C.MODEL.SWINV2.DECODER_DEPTHS = [2, 2, 6, 2]
...
_C.MODEL.SWINV2.FINAL_UPSAMPLE= "expand_first"
